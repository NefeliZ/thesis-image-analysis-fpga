...
// gassian blur with 3x3 window - integers - shifts 
//////
...
module tb_gaussblur3x3_int_shift;
    ...
    parameter string FILE_OUT = {path, "smeagol_verilog_out_gaussblur3x3_int_shift.txt"};
    ...
    initial begin
        ...
        $display("--------------------------------------------------");
        $display("Gaussian Blur 1 window 3x3 testbench - ints& shifts ");
        $display("--------------------------------------------------");
