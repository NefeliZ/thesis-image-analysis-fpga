...
// gauss filter with 5x5 window - ieee 
//////

module tb_gaussblur5x5_ieee;
    ...
    parameter string FILE_OUT = {path, "smeagol_verilog_out_gaussblur5x5_ieee.txt"};
    ...
    initial begin
        ...
        $display("-------------------------------------");
        $display(" Gauss 1 window 5x5 testbench - ieee ");
        $display("-------------------------------------");
