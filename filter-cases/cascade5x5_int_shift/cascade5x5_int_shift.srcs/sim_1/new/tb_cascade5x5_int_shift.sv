...
// cascaded filters with 5x5 window - integers - shifts 
//////

module tb_cascade5x5_int_shift;
    ...
    //double filter & 5x5 => lose 8 pixels per dimension
    localparam int EXPECTED_PIXELS = (IMG_WIDTH-8) * (IMG_HEIGHT-8); 
    ...
    initial begin
        ...
        $display("-----------------------------------------------------");
        $display("Cascaded filters window 5x5 testbench - ints& shifts ");
        $display("-----------------------------------------------------");
