...
//////////////////////////////////////////////////////////////////////////////////
//////
// gaussian blur with 3x3 window & ieee 754- testbench with input file 
// (from python preprocess)
//////

module tb_gaussblur_3x3_ieee;
    ...
    parameter string FILE_OUT = {path, "verilog_out_gaussblur_3x3_ieee.txt"};
        
    initial begin
    
        $display("--------------------------------------------------");
        $display("gaussian blur 1 window 3x3 testbench - img file input ");
        $display("--------------------------------------------------");
